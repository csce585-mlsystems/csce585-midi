...
# in_checkpoint = "./data/checkpoints/model_setpstep=4000.ckpt"
# out_checkpoint = "./data/checkpoints/inference_4000.pt"

# convert_checkpoint.convert_checkpoint(in_checkpoint, out_checkpoint, half_precision=False)
model = generate.load_inference_model("./data/checkpoints/inference_4000.pt")

start_tokens = [
    TOKENIZER.vocab["genre_unknown"],
    TOKENIZER.vocab["genre_unknown"],
    TOKENIZER.vocab["prog_0"]
]
